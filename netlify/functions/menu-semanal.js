...
${Object.keys(diasEspeciales).length > 0 ? `Días especiales: ${JSON.stringify(diasEspeciales)}` : ''}
...
- categoria coincide con tipo_comida: desayuno→desayuno, comida→comida o cocina de siempre, merienda→merienda, cena→cena.
- No repitas la misma receta más de 2 veces.
- Equilibra calorías entre días (no más de 400 kcal de diferencia entre días).
- En días de gimnasio prioriza recetas con más proteína.
- En días especiales marca esa comida con la receta más ligera o la más rápida.
- Si tiene poco tiempo, prioriza recetas con taper:true y tiempo_minutos bajo.
